...
<body>
  <div class="container">
    <div class="invoice mx-auto" style="max-width: 900px;">
        ...
        <table class="table align-middle">
          <thead class="table-light">
            ...
            <tr class="item-row">
              ...
              <td><input type="number" min="0" step="0.01" class="form-control form-control-sm unit_price" value="100.00"></td>
      ...
      <div class="d-flex justify-content-between align-items-center mb-3 no-print">
        ...
        <div class="text-end" style="min-width: 300px;">
          <div class="row g-2">
            ...
            <div class="col-6 text-end fw-semibold" id="subtotal">0.00</div>
      ...
      <div class="d-flex justify-content-between align-items-center no-print">
        <div>
          <small class="text-muted">Bank: Your Bank · A/C: 000-111-222 · SWIFT: ABCD</small>
        </div>
        <div>
  ...
  <script>
    // ✅ Subtotal function should be defined globally


    function updateSubtotal() {
      let subtotal = 0;
      $(".new").each(function() {
        let lineTotalText = $(this).find("td").eq(4).text().trim();
        let lineTotal = parseFloat(lineTotalText) || 0;
        subtotal += lineTotal;
      });
    ...
    function updateGrandTotal() {
      ...
      let total = subtotal + taxAmount + shipping - discount;
    ...
    // Trigger recalculation when cost fields are changed
    $("#taxPercent, #discount, #shipping").on("input", function() {
      updateGrandTotal();
    });
    ...
    $(function() {
      ...
      // ✅ Quantity change for single (top) product section
    ...
    // ✅ Remove row and recalculate subtotal
