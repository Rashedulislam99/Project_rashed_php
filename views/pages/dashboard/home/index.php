        ...
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-3"> <?php echo User::count() ?>  <span class="badge bg-light-success border border-success"><i
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-3"> <?php echo Order::count() ?> <span class="badge bg-light-warning border border-warning"><i
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-3"><?php echo Order::total_sell() ?>  <span class="badge bg-light-danger border border-danger"><i
                    class="ti ti-trending-down"></i> 27.4%</span></h4>
